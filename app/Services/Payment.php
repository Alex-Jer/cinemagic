...
class Payment
{
    ...
    public static function payWithVisa($card_number, $cvc_code): bool
    {
    ...
    public static function payWithPaypal($email_address): bool
    {
    ...
    public static function payWithMBWay($phone_number): bool
    {
