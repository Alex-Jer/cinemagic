...
@if (Auth::user() && Auth::user()->isCustomer())
    <x-dashboard.sidebar-group label="Histórico">
        ...
        </x-dashboard.sidebar-group-item>

        <x-dashboard.sidebar-group-item label="Bilhetes" route="tickets">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
@if (Auth::user() && !Auth::user()->isEmployee())
    <x-dashboard.sidebar-item label="Perfil" route="profile">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
@if (Auth::user() && Auth::user()->isEmployee())
    <x-dashboard.sidebar-item label="Controlo de acesso" route="employee.screenings">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <x-dashboard.sidebar-item label="Utilizadores" route="employee.users">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
@if (Auth::user() && Auth::user()->isAdmin())
    <x-dashboard.sidebar-group label="Gestão">
        ...
        <x-dashboard.sidebar-group-item label="Salas" route="admin.screens">
        ...
        <x-dashboard.sidebar-group-item label="Filmes" route="admin.films">
            <svg class="w-5 h-5 mt-px mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z">
                </path>
        ...
        <x-dashboard.sidebar-group-item label="Sessões" route="admin.screenings">
            <svg class="w-5 h-5 mt-px mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <x-dashboard.sidebar-group-item label="Utilizadores" route="admin.users">
            <svg class="w-5 h-5 mt-px mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">
                </path>
        ...
        <x-dashboard.sidebar-group-item label="Configurações" route="admin.config">
            <svg class="w-5 h-5 mt-px mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
