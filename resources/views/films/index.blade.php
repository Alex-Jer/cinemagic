        ...
        <div class="grid gap-x-14 mb-8 md:grid-cols-4 xl:grid-cols-5">
            @foreach ($films as $film)
                <a href="{{ 'films/' . $film->id }}" class="-mr-12">
                    <div
                        class="flex flex-wrap w-4/5 h-4/5 items-center justify-center mb-12 rounded-lg shadow-xs dark:bg-gray-800 transition ease-in-out delay-100 500 hover:-translate-y-1 hover:scale-110  duration-200">
