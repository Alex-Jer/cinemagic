                                    ...
                                    <div class="flex items-center text-sm">
                                        <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="{{ asset('storage/cartazes/' . $ticket['screening']->film->cartaz_url) }}"
                                                alt="{{ $ticket['screening']->film->titulo }}"
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                                {{ $ticket['screening']->film->ano }}</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
                                        <p class="font-semibold">{{ $ticket['screening']->film->genre->nome }}</p>
                                    </div>
                                </td>
                                <td class="px-4 py-3">
                                    <div class="flex items-center text-sm">
